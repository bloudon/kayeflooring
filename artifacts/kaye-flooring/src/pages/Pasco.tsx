...
const FAQS: FaqItem[] = [
  {
    name: "Do you install flooring in Pasco County, FL?",
    acceptedAnswer: { text: "Yes. Kaye Flooring Inc regularly installs hardwood, luxury vinyl plank (LVP), and custom stair flooring throughout Pasco County, including New Port Richey, Zephyrhills, Dade City, Wesley Chapel, and Land O' Lakes." }
  },
  {
    name: "What type of flooring works best in Pasco County homes?",
    acceptedAnswer: { text: "Luxury vinyl plank (LVP) is the top choice for Pasco County homeowners because it is 100% waterproof — essential in Florida's humid climate. LVP handles moisture cycles without warping or cupping. For bedrooms or living areas where you want the look and feel of real wood, engineered hardwood is an excellent option that performs well in Pasco County's climate when properly acclimated and installed." }
  },
  {
    name: "How long does flooring installation take in a Pasco County home?",
  ...
  {
    name: "Do you offer free estimates in Pasco County?",
    acceptedAnswer: { text: "Yes. We provide free, no-obligation in-home estimates throughout Pasco County. We bring samples to your home so you can evaluate flooring options in your actual space and lighting before making any commitment." }
  },
];
  ...
  "@graph": [
    {
      ...
      "description": "Licensed flooring installation contractor serving Pasco County, FL. Specializing in hardwood, luxury vinyl plank, and custom stair installation for residential homes in New Port Richey, Zephyrhills, Dade City, Wesley Chapel, and surrounding communities.",
      "url": "https://kayeflooring.com/pasco-county-flooring",
      ...
      "areaServed": [
        ...
        { "@type": "City", "name": "Dade City", "containedInPlace": { "@type": "State", "name": "Florida" } },
        ...
        { "@type": "City", "name": "Port Richey", "containedInPlace": { "@type": "State", "name": "Florida" } },
        { "@type": "City", "name": "Holiday", "containedInPlace": { "@type": "State", "name": "Florida" } }
      ],
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Flooring Installation Services — Pasco County, FL",
        "itemListElement": [
          { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Luxury Vinyl Plank (LVP) Installation", "description": "Waterproof, durable LVP flooring ideal for Pasco County's year-round humidity and active households." } },
          { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hardwood Flooring Installation", "description": "Solid and engineered hardwood installation for Pasco County homes seeking timeless elegance and lasting value." } },
          { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Custom Stair Installation", "description": "Stair tread replacement and full staircase renovation serving New Port Richey, Wesley Chapel, and throughout Pasco County." } },
          { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Floor Repair & Refinishing", "description": "Hardwood refinishing and floor repair services for existing flooring throughout Pasco County." } }
        ]
      },
      "aggregateRating": {
...
const COMMUNITIES = [
  { name: "New Port Richey", county: "Pasco County", note: "Gulf Coast city & county hub" },
  { name: "Zephyrhills", county: "Pasco County", note: "East Pasco growing community" },
  { name: "Dade City", county: "Pasco County", note: "Historic county seat" },
  { name: "Wesley Chapel", county: "Pasco County", note: "Rapidly growing suburban corridor" },
  { name: "Land O' Lakes", county: "Pasco County", note: "South Pasco residential area" },
  { name: "Port Richey", county: "Pasco County", note: "Coastal Gulf community" },
  { name: "Holiday", county: "Pasco County", note: "West Pasco established neighborhood" },
  { name: "San Antonio", county: "Pasco County", note: "Rural north Pasco community" },
];
...
const SERVICES = [
  {
    ...
    badge: "Most Popular",
    desc: "Waterproof, scratch-resistant, and indistinguishable from real wood — LVP is the top choice for Pasco County homeowners. Whether you're in a waterfront home in New Port Richey or a newer build in Wesley Chapel, Florida's humidity demands a floor that can take it. LVP handles moisture cycles without warping, cupping, or requiring the upkeep natural hardwood demands.",
  ...
  },
  {
    ...
    badge: null,
    desc: "Real wood flooring adds lasting value and timeless character to Pasco County homes. We install solid and engineered hardwood with precision attention to acclimation, subfloor preparation, and seamless transitions between rooms. Engineered hardwood is especially well-suited to Pasco County's humidity-heavy climate.",
...
export default function Pasco() {
  useEffect(() => {
    ...
    document.title = "Flooring Installation in Pasco County, FL | Kaye Flooring Inc";

    const script = document.createElement("script");
    script.type = "application/ld+json";
    script.id = "pasco-schema";
    script.text = JSON.stringify(SCHEMA);
    document.head.appendChild(script);

    return () => {
      document.title = prev;
      document.getElementById("pasco-schema")?.remove();
    };
  }, []);
  ...
  return (
    <div className="w-full">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          <motion.div initial="hidden" animate="visible" variants={STAGGER}>
            ...
            <motion.h1 variants={FADE_UP} className="text-4xl md:text-6xl font-serif font-bold text-white leading-tight mb-6 text-balance">
              Flooring Installation<br className="hidden md:block" /> in Pasco County, FL
            </motion.h1>
            <motion.p variants={FADE_UP} className="text-lg md:text-xl text-primary-foreground/85 mb-10 max-w-2xl font-light leading-relaxed">
              Hardwood, luxury vinyl plank, and custom stair installation for homeowners in New Port Richey, Zephyrhills, Wesley Chapel, and throughout Pasco County. Family-owned, fully licensed, and built for Florida's climate.
            </motion.p>
            <motion.div variants={FADE_UP} className="flex flex-col sm:flex-row gap-4">
              <Link href="/contact?ref=pasco-hero">
      ...
      {/* WHY PASCO COUNTY HOMEOWNERS CHOOSE KAYE */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={STAGGER}>
              ...
              <motion.h3 variants={FADE_UP} className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-6 leading-snug">
                The flooring contractor Pasco County residents refer to their neighbors
              </motion.h3>
              <motion.p variants={FADE_UP} className="text-muted-foreground leading-relaxed mb-8">
                Pasco County is one of Florida's fastest-growing areas — from Wesley Chapel's new-construction neighborhoods to the established coastal communities along New Port Richey's Gulf shoreline. Whether it's a new build that needs its first floor or an older home ready for an upgrade, every Pasco County house faces the same Florida challenge: heat, humidity, and a climate that demands flooring built to last.
              </motion.p>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={STAGGER} className="text-center mb-14">
            ...
            <motion.h3 variants={FADE_UP} className="text-3xl font-serif font-bold text-foreground">
              Flooring services we provide in Pasco County
            </motion.h3>
          </motion.div>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start gap-6">
                  ...
                  <div className="shrink-0">
                    <Link href={`/contact?ref=pasco-${svc.name.toLowerCase().replace(/\s+/g, '-')}`}>
      ...
      <section className="py-20 bg-background border-t border-border">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={STAGGER}>
              <motion.h2 variants={FADE_UP} className="text-sm font-semibold text-primary uppercase tracking-widest mb-3">Flooring in Pasco County</motion.h2>
              <motion.h3 variants={FADE_UP} className="text-3xl font-serif font-bold text-foreground mb-5 leading-snug">
                Flooring that fits Pasco County's pace of growth
              </motion.h3>
              <motion.div variants={FADE_UP} className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Pasco County is in the middle of one of Florida's most significant growth surges. Wesley Chapel alone has become one of the fastest-growing communities in the entire state, drawing families who want newer construction, good schools, and easy access to Tampa — without the city's price tag. Meanwhile, New Port Richey and Port Richey offer established waterfront neighborhoods with a character all their own.
                </p>
                <p>
                  That range — from brand-new builds to 1970s ranches — means every flooring job in Pasco County has its own set of challenges. New construction requires careful coordination with other trades and protection of fresh concrete slabs. Older homes often need subfloor leveling, moisture mitigation, or removal of multiple layers of previous flooring before a new installation can succeed.
                </p>
                <p>
                  We've done both. LVP dominates in Pasco County because it is the practical answer to Florida humidity, busy households, and pets. Engineered hardwood is the choice when a homeowner wants the warmth of real wood in a drier part of the home. Either way, we bring the same precision that's earned us five-star reviews across Central Florida.
                </p>
              </motion.div>
            </motion.div>
        ...
        <div className="container mx-auto px-4 text-center max-w-2xl">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={STAGGER}>
            <motion.h2 variants={FADE_UP} className="text-4xl font-serif font-bold text-white mb-4">
              Ready for new floors in Pasco County?
            </motion.h2>
            <motion.p variants={FADE_UP} className="text-primary-foreground/80 text-lg mb-8">
              We'll bring samples right to your home in New Port Richey, Zephyrhills, Wesley Chapel, or anywhere in Pasco County — and provide a free, no-pressure estimate. Most estimates are scheduled within 48 hours.
            </motion.p>
            <motion.div variants={FADE_UP} className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact?ref=pasco-cta">
